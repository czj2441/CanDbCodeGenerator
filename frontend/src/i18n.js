const dict = {
  zh: {
    ...
    'panel.signalMax': '最大值',
    'panel.signalUnit': '单位',
    'panel.littleEndian': '小端 (Intel)',
    'panel.bigEndian': '大端 (Motorola)',
    'panel.actions': '操作',
  ...
  en: {
    ...
    'panel.littleEndian': 'Little Endian (Intel)',
    'panel.bigEndian': 'Big Endian (Motorola)',
    ...
    'batch.littleEndian': 'little_endian',
    'batch.bigEndian': 'big_endian',
    'batch.factor': 'Factor',
    'batch.offset': 'Offset',
    'batch.min': 'Min',
    'batch.max': 'Max',
